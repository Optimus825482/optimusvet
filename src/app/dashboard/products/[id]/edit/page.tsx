                ...
                <Card>
                    <CardContent className="pt-6">
                        <div className="flex items-center justify-center gap-4">
                            ...
                            >
                                <Package className={`h-5 w-5 ${!isService ? "text-emerald-600" : "text-slate-400"}`} />
                                <span className={`font-medium ${!isService ? "text-emerald-700" : "text-slate-600"}`}>
                                    Ürün
                                </span>
                            </button>
                            <button
                            ...
                            >
                                <Tag className={`h-5 w-5 ${isService ? "text-purple-600" : "text-slate-400"}`} />
                                <span className={`font-medium ${isService ? "text-purple-700" : "text-slate-600"}`}>
                                    Hizmet
                                </span>
                            </button>
                        </div>
