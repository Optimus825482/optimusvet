...
type Protocol = ProtocolResponse;
...
export default function ProtocolDetailPage() {
  ...
  const {
    ...
    queryFn: async () => {
      ...
      // Runtime type validation - defensive check
      if (!isValidProtocolResponse(data)) {
        console.error("Invalid protocol response:", data);
        throw new Error("Geçersiz protokol verisi");
      }
    ...
    return (
      <div className="text-center py-12">
        ...
        <Link
          ...
          className="text-violet-500 hover:underline mt-4 inline-block"
        >
          Protokoller'e Dön
        </Link>
      </div>
            ...
            <div className="flex items-center gap-3 mb-4">
              <div
                className={`w-10 h-10 rounded-lg flex items-center justify-center ${
                  protocol.animal.species === "DOG"
                    ? "bg-amber-500/10 text-amber-500"
                    : protocol.animal.species === "CAT"
                      ? "bg-orange-500/10 text-orange-500"
                      : protocol.animal.species === "BIRD"
                            ...
                            <div className="mt-3 pt-3 border-t border-zinc-800/50 space-y-2">
                              ...
                              {step.completedAt && (
                                <p className="text-sm text-emerald-500">
                                  ✓ {formatDate(step.completedAt)} tarihinde
                                  tamamlandı
                                </p>
                              )}
                              {step.notes && (
